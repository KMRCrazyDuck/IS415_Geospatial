...
```{r}
pacman::p_load(sf, tmap, tidyverse, readr, dplyr, tidyr)
```

## 2.2 Importing a geospatial data into R
...
#### 2.5.2.2 Drawing choropleth map using tm_polygons()
...
### 2.5.7 Mapping Spatial Object Meeting a Selection Criterion
